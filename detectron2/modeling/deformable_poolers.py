...
from detectron2.layers import ROIAlign, ROIAlignRotated, cat, DeformRoIPooling

__all__ = ["DeformableROIPooler"]
...
class DeformableROIPooler(nn.Module):
    """
    ...
    def __init__(
        ...
        self.level_poolers = nn.ModuleList(
            DeformRoIPooling(scale, output_size[0], 256, False) for scale in scales)
    ...
    def forward(self, x, box_lists, delta):
        """
        Args:
